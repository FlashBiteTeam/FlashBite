...
exports.OTPRegisterRestaurante = void 0;
const domain_1 = require("../../../domain");
const custom_errors_1 = require("../../errors/custom.errors");
class OTPRegisterRestaurante {
    ...
    execute(dto, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.repository.deleteOneRestaurante(dto.email);
...
exports.OTPRegisterRestaurante = OTPRegisterRestaurante;

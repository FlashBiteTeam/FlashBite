    ...
    execute(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { contrasena } = dto, userDto = __rest(dto, ["contrasena"]);
                const contrasenaHasheada = bcrypt_adapter_1.bcriptAdapter.hash(contrasena);
                //* hash password
                const user = yield this.repository.createUser(Object.assign(Object.assign({}, userDto), { contrasena: contrasenaHasheada }));
                return user;
            }
            catch (error) {
